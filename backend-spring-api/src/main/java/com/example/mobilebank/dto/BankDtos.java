...
public class BankDtos {
    public record MoneyRequest(BigDecimal amount, String memo, LocalDate expiryDate) {}
    ...
    public record TransactionResponse(Long id, String type, BigDecimal amount, String fromAccountNumber, String toAccountNumber, String memo, LocalDate expiryDate, LocalDateTime createdAt) {}
